...
def get_topocore_deprecation_policy() -> dict[str, Any]:
    return {
        ...
        "legacy_runtime_status": TOPOCORE_V5_STATUS,
        "legacy_runtime_role": TOPOCORE_V5_ROLE,
        "legacy_runtime_disabled_by_default": TOPOCORE_V5_DISABLED_BY_DEFAULT,
        "legacy_runtime_allow_env": TOPOCORE_V5_ALLOW_DEPRECATED_ENV,
        "legacy_runtime_not_allowed_reason": TOPOCORE_V5_DEPRECATED_NOT_ALLOWED_REASON,
        "legacy_runtime_allowed_reason": TOPOCORE_V5_DEPRECATED_ALLOWED_REASON,
        "legacy_runtime_default_disabled_reason": TOPOCORE_V5_DEFAULT_DISABLED_REASON,
        "legacy_runtime_removed_reason": TOPOCORE_V5_RUNTIME_REMOVED_REASON,
        ...
        "legacy_runtime_removal_approved": TOPOCORE_V5_REMOVAL_APPROVED,
        "legacy_runtime_removed": TOPOCORE_V5_RUNTIME_REMOVED,
        "legacy_runtime_removal_completed": TOPOCORE_V5_REMOVAL_COMPLETED,
        "legacy_runtime_code_deprecation_active": TOPOCORE_V5_CODE_DEPRECATION_ACTIVE,
        "legacy_runtime_fallback_required": TOPOCORE_V5_FALLBACK_REQUIRED,
        "legacy_runtime_simulation_env": TOPOCORE_V5_SIMULATION_ENV,
        "legacy_runtime_simulated_disabled_reason": TOPOCORE_V5_SIMULATED_DISABLED_REASON,
        "legacy_runtime_off_simulation_available": TOPOCORE_V5_OFF_SIMULATION_AVAILABLE,
    }
