...
This document explains RepoBrain readiness at startup stage: externally evaluable, pre-marketplace, and intentionally bounded.
...
1. External review/fix is unsupported.
