...
- External GitHub mode foundation on third-party repos for help/doctor/ask plus bounded read-only Review Candidate and bounded Fix-Lite suggestion-only mode.
